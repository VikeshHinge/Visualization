...
const Navbar = () => {
  return (
   <Flex p='5px'justifyContent='space-between' alignItems='end' bg='blue.500'>
     
       <Box display={{base:'block',md:'none'}}> <Sidedrower/> </Box>
      <Text as='b' pl='15px' fontSize={{base:'18px',md:'30px'}}></Text>
    ...
    <Flex alignItems='center' w='fit-content' gap='10px' pr='10px' >
      ...
      <Box  display={{base:'none',md:'block'}}><IoIosKeypad  size='50px'/></Box>
    </Flex>
   </Flex>
  )
}
